                ...
                <div class="card">
                    <div class="card-header">
                        <b>
                            ...
                            <a class="btn btn-primary btn-sm " href="{{ route('email') }}">Emails</a>
                        </b>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <br>
                        <form action="{{ route('email.edit', $item->uuid) }}" method="post">
                            @csrf
                            <div class="form-group mt-3 mb-3">
                                <div class="row">
                                    <div class="col">
                                        <small>email</small>
                                        <input type="text" class="form-control" onkeypress="return isNumberKey(event);" placeholder="email Number" name="email" value="{{ $item->email }}" autocomplete="off">
                                    </div>
                                    <div class="col">
                                        <small>SCN</small>
